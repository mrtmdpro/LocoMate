  ...
  return (
    <div className="pb-32">
      ...
      <div className="bg-gradient-to-br from-[#ff8c30] to-[#e67a20] p-6 pb-12 relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1573455494060-c5595004fb6c?w=1200&h=600&fit=crop" alt="" className="absolute inset-0 w-full h-full object-cover opacity-25 z-0" />
